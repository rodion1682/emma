(() => {
    ...
    let mainSlider = new core(".page", {
        modules: [ Pagination, Scrollbar, Keyboard, Mousewheel, freeMode ],
        observer: true,
        observeParents: true,
    ...
    if (document.querySelector(".works")) new core(".works", {
